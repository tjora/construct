...
class TestContainer(unittest.TestCase):
    ...
    @pytest.mark.xfail(not PY2, reason="string format is different on 2 and 3")
    def test_str_full_printing_py2(self):
    ...
    @pytest.mark.xfail(not PY3, reason="string format is different on 2 and 3")
    def test_str_full_printing_py3(self):
        setglobalfullprinting(True)
        c = Container(data=b"\x01\x02\x034567890")
        assert str(c) == ("Container: \n    data = \\x01\\x02\\x034567890 (total 10)")
        # c = Container(data=u"\x01\x02\x034567890")
